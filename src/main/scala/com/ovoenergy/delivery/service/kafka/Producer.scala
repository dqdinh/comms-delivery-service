...
object Producer {
  ...
  def apply[E: SchemaFor: ToRecord](topic: Topic[E]): Either[Retry.Failed, KafkaProducer[String, E]] = {
    ...
    val initialSettings = Map(
      ...
      // TODO Enable idempotency when https://issues.apache.org/jira/browse/KAFKA-6817 has been addressed
      ProducerConfig.ENABLE_IDEMPOTENCE_CONFIG -> "false",
      // TODO Remove when https://issues.apache.org/jira/browse/KAFKA-6817 has been addressed
  ...
  def produce[E](getKey: E => String, producer: KafkaProducer[String, E], topicName: String): Producer[E] =
    new Producer[E](getKey, producer, topicName)
}
