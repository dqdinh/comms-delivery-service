...
trait LoggingWithMDC {
  ...
  def logDebug[A: Loggable](a: A, message: => String): Unit = {
  ...
  def logInfo[A: Loggable](a: A, message: => String): Unit = {
  ...
  def logWarn[A: Loggable](a: A, message: => String): Unit = {
  ...
  def logWarn[A: Loggable](a: A, message: => String, throwable: Throwable): Unit = {
    withMDC(a -> throwable)(log.warn(message, throwable))
  }

  def logWarn(message: => String, throwable: Throwable): Unit = {
    withMDC(throwable)(log.warn(message, throwable))
  }

  def logError[A: Loggable](a: A, message: => String): Unit = {
    withMDC(a)(log.error(message))
  }
  def logError[A: Loggable](a: A, message: => String, throwable: Throwable): Unit = {
